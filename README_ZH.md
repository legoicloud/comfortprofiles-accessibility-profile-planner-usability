...
独立的项目设计文档，适用对象： **Windows accessibility**。
...
- **输入舒适度配置** (Input comfort profiles) — 规划模块，尚未实现。
- **文字缩放说明** (Text scaling notes) — 规划模块，尚未实现。
- **配置恢复清单** (Configuration restore checklist) — 规划模块，尚未实现。
